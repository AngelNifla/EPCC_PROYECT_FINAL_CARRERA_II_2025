...
def main():
    ...
    dataPreprocess_bert("benign_small.txt", input_ids, input_types, input_masks, label, 0)
    dataPreprocess_bert("malware_small.txt", input_ids, input_types, input_masks, label, 1)
